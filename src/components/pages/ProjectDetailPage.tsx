...
export default function ProjectDetailPage() {
  ...
  const tileClass = cn(
    "grid h-[54px] w-[54px] flex-none place-items-center overflow-hidden rounded-[14px] text-[15px] font-bold",
    canEdit &&
      "cursor-pointer transition-shadow hover:shadow-[0_0_0_3px_var(--color-accent-soft)]",
  )
          ...
          <div className="flex items-center gap-4 min-w-0">
            ...
            <div className="flex flex-col gap-1.5 min-w-0">
              ...
              <div className="flex items-center flex-wrap gap-x-3 gap-y-1">
                ...
                <span className="text-[13px] text-fg-muted">{languageName}</span>
