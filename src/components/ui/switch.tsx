...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitive.Thumb
      className={cn(
        "pointer-events-none block h-[1.125rem] w-[1.125rem] rounded-full bg-on-dark shadow-[0_0.0625rem_0.1875rem_--alpha(var(--color-scrim)/30%)] ring-0 transition-transform",
